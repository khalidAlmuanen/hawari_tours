      ...
      <section className="relative h-screen min-h-[700px] overflow-hidden bg-black">
        ...
        <div className="relative h-full flex items-center z-20">
          <div className="container-custom relative">
            ...
            <div className="pointer-events-none absolute inset-y-0 right-0 hidden xl:flex items-center justify-end">
              <div className="relative mr-4 2xl:mr-10">
                <div className="absolute inset-0 rounded-[2.5rem] bg-gradient-to-br from-orange-500/30 via-amber-300/15 to-cyan-400/15 blur-3xl" />
                <div className="relative overflow-hidden rounded-[2.5rem] border border-white/15 bg-white/10 px-8 py-8 backdrop-blur-2xl shadow-[0_30px_90px_rgba(0,0,0,0.35)]">
                  <div className="absolute inset-x-8 top-0 h-px bg-gradient-to-r from-transparent via-white/80 to-transparent" />
                  <div className="absolute -top-16 -right-12 h-32 w-32 rounded-full bg-orange-400/20 blur-3xl" />
                  <div className="absolute -bottom-10 -left-10 h-28 w-28 rounded-full bg-cyan-400/15 blur-3xl" />
                  <BrandLogo
                    alt="Hawari Tours"
                    priority
                    className="relative mx-auto w-[220px] 2xl:w-[250px]"
                    imageClassName="drop-shadow-[0_16px_30px_rgba(0,0,0,0.18)]"
                  />
                  <div className="mt-5 flex items-center justify-between text-white/85">
                    <span className="rounded-full border border-white/15 bg-black/15 px-4 py-2 text-xs font-semibold tracking-[0.22em]">
                      {locale === 'ar' ? 'هوية بصرية' : 'BRAND IDENTITY'}
                    </span>
                    <span className="text-sm font-medium text-white/70">
                      {locale === 'ar' ? 'رحلات سقطرى الفاخرة' : 'Socotra Luxury Travel'}
                    </span>
                  </div>
                </div>
              </div>
