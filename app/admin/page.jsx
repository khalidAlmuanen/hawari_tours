...
export default function AdminDashboard() {
  ...
  const formatNumber = (value) => new Intl.NumberFormat(isAr ? 'ar' : 'en-US').format(value || 0)
  ...
  const getStatusLabel = (status) => statusLabels[status]?.[isAr ? 'ar' : 'en'] || status

  const quickActions = [
    {
      href: '/admin/bookings',
      icon: '📅',
      label: { ar: 'إدارة الحجوزات', en: 'Manage Bookings' },
      description: { ar: 'تحديث الحالات والمتابعة', en: 'Update statuses and track' }
    },
    {
      href: '/admin/tours',
      icon: '✈️',
      label: { ar: 'إدارة الجولات', en: 'Manage Tours' },
      description: { ar: 'إضافة وتعديل الجولات', en: 'Add and edit tours' }
    },
    {
      href: '/admin/destinations',
      icon: '🏛️',
      label: { ar: 'إدارة المعالم', en: 'Manage Destinations' },
      description: { ar: 'تنظيم الوجهات', en: 'Organize destinations' }
    },
    {
      href: '/admin/news',
      icon: '📰',
      label: { ar: 'إدارة الأخبار', en: 'Manage News' },
      description: { ar: 'نشر الأخبار والتحديثات', en: 'Publish updates' }
    },
    {
      href: '/admin/messages',
      icon: '📧',
      label: { ar: 'إدارة الرسائل', en: 'Manage Messages' },
      description: { ar: 'الرد والمتابعة', en: 'Respond and follow up' }
    },
    {
      href: '/admin/settings',
      icon: '⚙️',
      label: { ar: 'إعدادات النظام', en: 'System Settings' },
      description: { ar: 'التحكم العام بالنظام', en: 'Overall system control' }
    }
  ]
      ...
      <div className="space-y-8">
        {stats && (
          <>
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      >
                        ...
                        <span>{formatGrowth(stats.toursGrowth)}</span>
                      </motion.div>
                    </div>
                    <motion.div 
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      >
                        ...
                        <span>{formatGrowth(stats.bookingsGrowth)}</span>
                      </motion.div>
                    </div>
                    <motion.div 
                      initial={{ opacity: 0, scale: 0.5 }}
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      >
                        ...
                        <span>{formatGrowth(stats.revenueGrowth)}</span>
                      </motion.div>
                    </div>
                    <motion.div 
                      initial={{ opacity: 0, scale: 0.5 }}
            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl p-6 shadow-xl">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    {isAr ? 'تحكم مباشر بأهم الأقسام' : 'Direct control over key sections'}
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {quickActions.map((action) => (
                  <Link
                    key={action.href}
                    href={action.href}
                    className="group rounded-2xl border border-gray-100 dark:border-gray-700 bg-white/70 dark:bg-gray-900/40 p-4 hover:shadow-lg hover:-translate-y-0.5 transition-all"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400 truncate">
                          {isAr ? action.description.ar : action.description.en}
                        </div>
                      </div>
                    ...
                    {stats.recentBookings.map((booking, index) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <div className="font-bold text-gray-900 dark:text-white">{formatCurrency(booking.amount)}</div>
                          <div
              ...
              {(!stats.recentBookings || stats.recentBookings.length === 0) && (
                ...
                >
                  <div className="text-center py-10">
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      {isAr ? 'ستظهر آخر الحجوزات هنا عند توفرها' : 'Recent bookings will appear here'}
                    </div>
                  </div>
                </motion.div>
              )}
                ...
                >
                  ...
                  {stats.trafficSources.length === 0 ? (
                    <div className="text-center py-10">
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">
                        {isAr ? 'ستظهر المصادر بمجرد توفر الزيارات' : 'Traffic sources will appear once visits arrive'}
                      </div>
                    </div>
                  ) : (
