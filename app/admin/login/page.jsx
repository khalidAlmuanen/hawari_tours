...
export default function AdminLogin() {
  ...
  // ✅ FIX: Generate background animations only on client side
  ...
  useEffect(() => {
    ...
    // Generate random background elements only on client
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {mounted && backgroundElements.length > 0 && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-xl border-2 rounded-2xl text-white placeholder-white/50 focus:outline-none transition-all ${emailError
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={loading}
                  suppressHydrationWarning
                  className={`w-full pl-12 pr-14 py-4 bg-white/10 backdrop-blur-xl border-2 rounded-2xl text-white placeholder-white/50 focus:outline-none transition-all ${passwordError
                    ? 'border-red-500/50 focus:ring-2 focus:ring-red-400'
                    : 'border-white/20 focus:ring-2 focus:ring-blue-400'
                    } disabled:opacity-50 disabled:cursor-not-allowed`}
                />
