...
import { sendReplyNotification } from '@/lib/emailService'
...
export async function PUT(request) {
  ...
  try {
    ...
    // Send email notification if replied
    if (body.status === 'REPLIED' && body.reply && message.email) {
      try {
        await sendReplyNotification(message, body.reply)
      } catch (emailError) {
