        ...
        <div className="h-full px-6 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <Link href="/admin" className="flex items-center gap-3 group">
              <div className="relative rounded-[1.7rem] bg-white px-3 py-2 shadow-lg ring-1 ring-gray-200/70 transition-all duration-300 group-hover:scale-[1.03] dark:bg-gray-800 dark:ring-gray-700">
                <div className="absolute inset-0 rounded-[1.7rem] bg-gradient-to-br from-orange-500/20 via-amber-400/15 to-blue-500/15 blur-lg opacity-60 group-hover:opacity-80 transition-opacity"></div>
                <BrandLogo
                  alt="Hawari Tours"
                  className="relative w-[58px] sm:w-[66px]"
                />
              </div>
              <div>
