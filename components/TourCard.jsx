...
export default function TourCard({ tour }) {
  ...
  // Image (Database: cardImage, coverImage, images array OR images.main)
  const coverImage = tour.cardImage ||
    tour.coverImage ||
    tour.images?.main ||
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          {/* Location (NEW) */}
          {(tour.location || tour.locationAr) && (
            <div className="flex items-center gap-2 bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/10 px-3 py-2 rounded-lg border border-red-100 dark:border-red-800/40">
              <svg className="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span className="text-sm font-bold text-red-900 dark:text-red-100 line-clamp-1 max-w-[100px]">
        ...
        <div className="flex items-center justify-between pt-5 border-t-2 border-gray-100 dark:border-gray-700">
          ...
          >
            ...
            <svg className={`w-5 h-5 relative z-10 transform transition-transform ${isAr ? 'group-hover/btn:-translate-x-1' : 'group-hover/btn:translate-x-1'
      ...
      {/* Bottom Progress Bar */}
      <div
        className={`h-1 bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 transform origin-left transition-transform duration-500 ${isHovered ? 'scale-x-100' : 'scale-x-0'
          }`}
      />
    </div>
  )
