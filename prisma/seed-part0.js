// PART 0: Tours and Destinations
export const part0 = async (prisma) => {
    console.log('✈️  Creating tours...')

    const tour1 = await prisma.tour.create({
        data: {
            title: 'Socotra Complete Island Discovery', titleAr: 'اكتشاف جزيرة سقطرى الشامل',
            ...
            itinerary: {
                days: [
                    ...
                    { day: 4, titleEn: 'Hoq Cave Adventure', titleAr: 'مغامرة كهف حوق', descriptionEn: 'Trek to one of Arabia largest caves with ancient inscriptions inside.', descriptionAr: 'تنزه إلى أحد أكبر كهوف الجزيرة العربية مع نقوش قديمة بالداخل.' },
    ...
    const tour2 = await prisma.tour.create({
        data: {
            title: 'Dragon Blood Tree & Mountain Trek', titleAr: 'رحلة أشجار الدم والجبال',
            ...
            itinerary: {
                days: [
                    ...
                    { day: 3, titleEn: 'Skand Summit', titleAr: 'قمة سكند', descriptionEn: 'Summit hike with 360 degree island views. Overnight camping under the stars.', descriptionAr: 'تسلق القمة مع مناظر 360 درجة للجزيرة. التخييم طوال الليل.' },
    ...
    const tour3 = await prisma.tour.create({
        data: {
            title: 'Marine & Beach Paradise', titleAr: 'جنة الشواطئ والبحر',
    ...
    const tour4 = await prisma.tour.create({
        data: {
            title: 'Socotra Wildlife & Birdwatching Safari', titleAr: 'سفاري مراقبة الطيور والحياة البرية',
            slug: 'socotra-wildlife-birdwatching-safari',
            description: 'Expert-led safari covering key wildlife habitats. Spot 44 endemic bird species, rare reptiles, marine life and dolphins.',
            descriptionAr: 'سفاري بقيادة خبراء تغطي الموائل الحيوانية الرئيسية. اكتشف 44 نوعاً من الطيور المستوطنة والزواحف النادرة والحياة البحرية والدلافين.',
            ...
            itinerary: {
                days: [
                    ...
                    { day: 2, titleEn: 'Mountain Forest Birds', titleAr: 'طيور غابة الجبل', descriptionEn: 'Firmhin forest: Socotra Sunbird, Socotra Starling, endemic raptors.', descriptionAr: 'غابة فرمهين: طائر الشمس السقطري، زرزور سقطرى، والجوارح المستوطنة.' },
                    ...
                    { day: 5, titleEn: 'Endemic Reptiles & Departure', titleAr: 'الزواحف المستوطنة والمغادرة', descriptionEn: 'Socotra chameleon spotting before airport transfer.', descriptionAr: 'البحث عن حرباء سقطرى قبل المواصلات للمطار.' }
                ]
            },
            ...
            metaDescription: '5-day expert birdwatching safari in Socotra with 44 endemic bird species and rare reptiles.',
    ...
    const tour5 = await prisma.tour.create({
        data: {
            title: 'Socotra Cultural Heritage Immersion', titleAr: 'الانغماس في التراث الثقافي لسقطرى',
            slug: 'socotra-cultural-heritage-immersion',
            description: 'Live among the Socotri people. Stay in ancestral mountain villages, learn about the ancient unwritten Socotri language, and experience authentic island life.',
            descriptionAr: 'عش بين أهل سقطرى. أقم في القرى الجبلية الأصيلة وتعلم اللغة السقطرية القديمة غير المكتوبة وعش حياة الجزيرة الأصيلة.',
    ...
    await prisma.destination.createMany({
        data: [
            {
                name: 'Dixam Plateau', nameAr: 'هضبة ديكسم', slug: 'dixam-plateau',
                description: 'Home to the largest Dragon Blood Tree forest on Earth at 800m altitude.', descriptionAr: 'موطن أكبر غابة لأشجار الدم على وجه الأرض على ارتفاع 800 متر.',
                coverImage: 'https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=1200', images: [],
                latitude: 12.48, longitude: 53.95, category: 'NATURE',
                highlights: ['Dragon Blood Trees', 'Rock pools', 'Panoramic views', 'Ancient forest'],
            ...
            {
                name: 'Detwah Lagoon', nameAr: 'بحيرة ديتواه', slug: 'detwah-lagoon',
                description: 'UNESCO-recognized turquoise lagoon separated from the Indian Ocean by white sand.', descriptionAr: 'بحيرة فيروزية معترف بها من اليونسكو تفصلها عن المحيط الهندي رمال بيضاء.',
                coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1200', images: [],
                latitude: 12.71, longitude: 53.42, category: 'BEACH', unesco: true,
                highlights: ['Turquoise lagoon', 'White sand dunes', 'Flamingos', 'Mangrove forest'],
                activities: ['Swimming', 'Kayaking', 'Bird watching', 'Photography'],
                bestTimeToVisit: 'October to March', featured: true, isActive: true, viewsCount: 2890
            },
            {
                name: 'Hoq Cave', nameAr: 'كهف حوق', slug: 'hoq-cave',
                description: 'One of the largest caves in Arabia with 2000-year-old ancient inscriptions in 5 languages.', descriptionAr: 'أحد أكبر الكهوف في الجزيرة العربية مع نقوش قديمة عمرها 2000 عام بـ5 لغات.',
                coverImage: 'https://images.unsplash.com/photo-1518709268805-4e9042af9f23?w=1200', images: [],
                latitude: 12.63, longitude: 54.38, category: 'ARCHAEOLOGICAL',
                highlights: ['Ancient inscriptions', 'Massive stalactites', '4km length', 'Multi-language carvings'],
                activities: ['Cave exploration', 'History tours', 'Photography'],
                bestTimeToVisit: 'All year', featured: true, isActive: true, viewsCount: 1850
            },
            {
                name: 'Arher Sand Dunes', nameAr: 'كثبان أرهر الرملية', slug: 'arher-sand-dunes',
                description: 'Iconic white sand dunes cascading directly into crystal-clear turquoise water.', descriptionAr: 'كثبان رملية بيضاء أيقونية تنحدر مباشرة في مياه فيروزية شفافة.',
                coverImage: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=1200', images: [],
                latitude: 12.71, longitude: 54.50, category: 'BEACH',
                highlights: ['White dunes', 'Crystal water', 'Astrophotography', 'Sand boarding'],
                activities: ['Sandboarding', 'Swimming', 'Photography', 'Camping'],
                bestTimeToVisit: 'October to April', featured: true, isActive: true, viewsCount: 2100
            },
            {
                name: 'Dihamri Marine Reserve', nameAr: 'محمية ديهامري البحرية', slug: 'dihamri-marine-reserve',
                description: 'Protected marine park with 253 fish species, healthy corals and sea turtles. 30m+ visibility.', descriptionAr: 'حديقة بحرية محمية مع 253 نوعاً من الأسماك وشعاب صحية وسلاحف بحرية. رؤية 30 متراً وأكثر.',
                coverImage: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1200', images: [],
                latitude: 12.49, longitude: 53.84, category: 'WILDLIFE',
                highlights: ['253 fish species', 'Coral reefs', 'Sea turtles', '30m visibility'],
                activities: ['Snorkeling', 'Scuba diving', 'Marine photography'],
    ...
    return { tour1, tour2, tour3, tour4, tour5 }
}
